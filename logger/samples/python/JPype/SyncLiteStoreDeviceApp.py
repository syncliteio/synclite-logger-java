...
#
"""
Store device sample via JPype.

This sample shows using the `SQLITE_STORE` device from Python via JPype. It
demonstrates basic CRUD operations on a Store device and proper device
initialization/close semantics.
"""
