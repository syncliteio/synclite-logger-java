...
SyncLite.initialize(DeviceType.DBLOGGER, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.DBLOGGER, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DBLOGGER, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.DBLOGGER, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DBLOGGER, dbPath, propsPath, destination);
}
...
SyncLite.initialize(DeviceType.DBLOGGER, dbPath, propsPath, deviceName, destination);
}
