...
SyncLite.initialize(DeviceType.DERBY, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.DERBY, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DERBY, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.DERBY, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DERBY, dbPath, propsPath, destination);
}
...
SyncLite.initialize(DeviceType.DERBY, dbPath, propsPath, deviceName, destination);
}
