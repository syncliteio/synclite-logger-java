...
SyncLite.initialize(DeviceType.DERBY_APPENDER, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_APPENDER, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_APPENDER, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_APPENDER, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_APPENDER, dbPath, propsPath, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_APPENDER, dbPath, propsPath, deviceName, destination);
}
