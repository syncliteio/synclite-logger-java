...
SyncLite.initialize(DeviceType.DERBY_STORE, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_STORE, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_STORE, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_STORE, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DERBY_STORE, dbPath, propsPath, destination);
}
