...
public final class DuckDB extends SyncLite {    
	private final static String PREFIX = "jdbc:synclite_duckdb:";
    ...
    public final SQLiteConnection createSyncLiteConnection(String url, Properties prop) throws SQLException {
    	...
    	return new DuckDBConnection(url, extractAddress(url, PREFIX), prop); 
    }
...
SyncLite.initialize(DeviceType.DUCKDB, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.DUCKDB, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DUCKDB, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.DUCKDB, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.DUCKDB, dbPath, propsPath, destination);
}
...
SyncLite.initialize(DeviceType.DUCKDB, dbPath, propsPath, deviceName, destination);
}
