...
SyncLite.initialize(DeviceType.H2_APPENDER, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.H2_APPENDER, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.H2_APPENDER, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.H2_APPENDER, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.H2_APPENDER, dbPath, propsPath, destination);
}
