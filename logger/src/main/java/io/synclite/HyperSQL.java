...
SyncLite.initialize(DeviceType.HYPERSQL, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL, dbPath, propsPath, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL, dbPath, propsPath, deviceName, destination);
}
