...
SyncLite.initialize(DeviceType.HYPERSQL_APPENDER, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL_APPENDER, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL_APPENDER, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL_APPENDER, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL_APPENDER, dbPath, propsPath, destination);
}
...
SyncLite.initialize(DeviceType.HYPERSQL_APPENDER, dbPath, propsPath, deviceName, destination);
}
