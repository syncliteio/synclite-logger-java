...
SyncLite.initialize(DeviceType.SQLITE, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.SQLITE, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.SQLITE, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.SQLITE, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.SQLITE, dbPath, propsPath, destination);
}
...
SyncLite.initialize(DeviceType.SQLITE, dbPath, propsPath, deviceName, destination);
}
