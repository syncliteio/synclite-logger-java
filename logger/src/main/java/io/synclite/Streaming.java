...
SyncLite.initialize(DeviceType.STREAMING, dbPath, destination);
}
...
SyncLite.initialize(DeviceType.STREAMING, dbPath, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.STREAMING, dbPath, options, destination);
}
...
SyncLite.initialize(DeviceType.STREAMING, dbPath, options, deviceName, destination);
}
...
SyncLite.initialize(DeviceType.STREAMING, dbPath, propsPath, destination);
}
