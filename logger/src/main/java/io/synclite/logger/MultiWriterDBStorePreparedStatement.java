...
public class MultiWriterDBStorePreparedStatement extends SyncLiteStorePreparedStatement {
    ...
    // Package-private: skips DML validation — SQL is generated by an internal API layer.
    MultiWriterDBStorePreparedStatement(SQLiteConnection conn, String sql, boolean trusted) throws SQLException {
        super(conn, sql, true);
        pstmt = getConn().getNativeDBConnection().prepareStatement(sql);
    }
